  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        className={cn(
          "h-11 rounded-lg border px-3 text-sm transition-colors outline-none",
          "bg-white text-slate-900 placeholder:text-slate-400",
          "dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-500",
          error
            ? "border-red-500 focus:border-red-500 focus:ring-2 focus:ring-red-200 dark:focus:ring-red-900"
            : "border-slate-300 focus:border-slate-900 focus:ring-2 focus:ring-slate-200 dark:border-slate-700 dark:focus:border-slate-400 dark:focus:ring-slate-700",
          className,
        )}
        {...props}
      />

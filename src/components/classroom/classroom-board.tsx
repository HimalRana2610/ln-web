  ...
  return (
    <>
      ...
      <div
        ...
        className="mx-auto mb-6 flex w-full max-w-md gap-1 rounded-full bg-slate-200 p-1 dark:bg-slate-700"
      >
      ...
      <div className="fixed right-6 bottom-6 z-30 flex flex-col items-end gap-3">
        <button
          ...
          className="rounded-full bg-white px-4 py-2 text-sm font-medium text-slate-700 shadow-lg ring-1 ring-slate-200 transition hover:bg-slate-50 dark:bg-slate-700 dark:text-slate-100 dark:ring-slate-700"
        >
          Join with code
        </button>
